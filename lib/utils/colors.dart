...
class AppColors{
  ...
  static final Color mainColor = const Color(0xffdbbaba);
  ...
  static final Color buttonBackgroundColor = const Color(0xffc2b7b7);
  static final Color signColor = const Color(0xFF5c524f);
