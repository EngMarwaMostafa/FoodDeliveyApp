...
import 'package:fooddeliveryapp/pages/address/widgets/search_location_dialogue_page.dart';
...
class _PickAddressMapState extends State<PickAddressMap> {
  ...
  void initState() {
    ...
    if (Get.find<LocationController>().addressList.isEmpty) {
      _initialPosition = LatLng(30.087185, 31.340929);
                  ...
                  Positioned(
                    ...
                    child: locationController.isLoading?
                     Center(
                      ...
                      widget.fromAddress?'Pick Address':'Pick Location':'Service is not available in your area',
